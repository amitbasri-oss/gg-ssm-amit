...
class EyeTrackingModelModule(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        if self.training_params["arch_name"] == "retina_snn":
            param_list += [
                {
                    "params": self.model_lpf.tau_mem,
                    "lr": self.training_params["lr_model_lpf_tau"],
                },
                {
                    "params": self.model_lpf.tau_syn,
                    "lr": self.training_params["lr_model_lpf_tau"],
                },
                {
                    "params": self.model_lpf.scale_factor,
                    "lr": self.training_params["lr_model_lpf"],
                },
            ]
